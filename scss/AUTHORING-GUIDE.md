...
--component-header-bg: var(--semantic-color-surface-primary); // default
...
| Am I adding a raw CSS value (hex, px, etc.)?        | Stop → use a token instead                         |
